...
from opencood.utils.transformation_utils import x1_to_x2, dist_two_pose, tfm_to_pose, x_to_world
...
class BaseDataset(Dataset):
    ...
    def __init__(self, params, visualize, train=True, isSim=False):
        ...
        if 'wild_setting' in params:
            if 'prev_size' not in params['wild_setting']:
                params['wild_setting']['prev_size'] = 1
            interval_size = \
                params['wild_setting']['interval_size'] \
                    if 'interval_size' in params['wild_setting'] else 1    
    ...
    def add_loc_noise(self, pose, xyz_std, ryp_std):
        ...
        noise_pose = [pose[0] + xyz_noise[0],
                      ...
                      pose[5]]
        if trm_flag:
            noise_pose = x_to_world(noise_pose)
        return noise_pose
